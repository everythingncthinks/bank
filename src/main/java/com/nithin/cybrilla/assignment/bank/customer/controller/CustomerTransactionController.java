...
import com.nithin.cybrilla.assignment.bank.common.dto.transaction.ViewStatementRequest;
import com.nithin.cybrilla.assignment.bank.common.helper.HeaderData;
import com.nithin.cybrilla.assignment.bank.customer.service.CustomerTransactionService;
...
public class CustomerTransactionController {
    ...
    public ResponseEntity<Transaction> createTransaction(
        ...
        return new ResponseEntity<>(customerTransactionService.createTransaction(customerTransactionRequest),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<Transaction>> viewTransactions(@RequestHeader("user_id") String modifiedBy,
        ...
        HeaderData.setUserHeaderData(modifiedBy);
        return new ResponseEntity<>(customerTransactionService.viewTransactions(accountNumber), HttpStatus.OK);
    }
}
